...
Create a text file called answers.txt and provide the answers to the following questions:
...
You will submit your main.cpp and answers.txt files to Gradescope.
